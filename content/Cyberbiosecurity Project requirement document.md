...
The document is an early draft.

## Working definition

Cyberbiosecurity is the protection of biological data, biological research, biotechnology processes, and related organizations from cyber threats, while accounting for biosafety, biosecurity, and responsible use.
...
- **Cyberbiosecurity** sits at the intersection of these dimensions. The relationship between them is a subject for further review...

## Scope & sectors

The initial scope covers the digital systems, data, people, procedures, and physical infrastructure that support biological research, health, biotechnology, and related policy and security functions.
...
The initial guidance is intended for organizations and professionals who manage, secure, regulate, or support biological work.
...
The project includes a focus on nations in East- and Central Africa. Guidance should be practical for different levels of digital maturity, infrastructure, staffing, funding, and regulatory capacity.
...
2. Fouad, Noran Shafik. 2026. Constructing the Future in and of Cyberbiosecurity: Cyber-Bio Convergence and (In)Security Imaginaries. DOI: 10.1093/isagsq/ksag101. Local source: ksag101.pdf.
